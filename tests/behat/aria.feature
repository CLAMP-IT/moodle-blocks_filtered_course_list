...
Feature: The block includes ARIA support
  ...
  Scenario: Checking ARIA support
    ...
    And the "id" attribute of ".block-fcl__rubric.tab1" "css_element" should contain "tab1"
    And the "aria-controls" attribute of ".block-fcl__rubric.tab1" "css_element" should contain "panel1"
    And the "aria-expanded" attribute of ".block-fcl__rubric.tab1" "css_element" should contain "false"
    And the "aria-selected" attribute of ".block-fcl__rubric.tab1" "css_element" should contain "false"
    And the "role" attribute of ".block-fcl__rubric.tab1" "css_element" should contain "tab"
    ...
    And the "aria-controls" attribute of ".block-fcl__rubric.tab2" "css_element" should contain "panel2"
    And the "aria-expanded" attribute of ".block-fcl__rubric.tab2" "css_element" should contain "true"
    And the "aria-selected" attribute of ".block-fcl__rubric.tab2" "css_element" should contain "false"
    ...
    Then the "aria-expanded" attribute of ".block-fcl__rubric.tab1" "css_element" should contain "true"
    And the "aria-selected" attribute of ".block-fcl__rubric.tab1" "css_element" should contain "true"
    ...
    Then the "aria-expanded" attribute of ".block-fcl__rubric.tab2" "css_element" should contain "false"
    And the "aria-selected" attribute of ".block-fcl__rubric.tab2" "css_element" should contain "true"
