...
class filter extends \block_filtered_course_list\local\filter_base {
    public $configvalidator = "\\block_filtered_course_list\\local\\filter_completion\\config_validator";
    ...
    public function get_rubrics() {
        ...
        $this->rubrics[] = new \block_filtered_course_list\local\rubric($this->config['label'], $courselist,
