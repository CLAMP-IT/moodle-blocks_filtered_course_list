...
abstract class filter {
     ...
     * Constructor
     *
     * @param array $config The first element is the config type, the second is the rest of the line
     * @param array $courselist An array of courses the user is enrolled in
     * @param array $fclconfig Details of the block configuration
     */
    public function __construct($config, $courselist, $fclconfig) {
        $this->config = $this->validate_line($config);
     ...
     *
     * @param int $index The index of the $config array that should contain the expanded value
