...
$string['configcustomlabel']        = 'Enter a custom section title under which to organize courses.';
...
$string['configmaxallcourse']       = 'On a site with only one category, admins and guests will see all courses, <br />but above this number they will see a category link instead.';
